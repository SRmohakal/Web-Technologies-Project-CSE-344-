    ...
    px-8 md:pt-30 pt-20 text-left'>
      ...
      {/*left column */}
        ...
        {/* review and ratings */}
            ...
            <p className='text-sm'>Course by <span className='text-blue-600 underline'>Shourov Roy</span></p>
            ...
            <div className='py-20 text-sm md:text-default'> {/*add className latter */}
